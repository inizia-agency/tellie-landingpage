...
export function HardwarePrototypeSection() {
  return <section className="mt-16">
    ...
    <div className="mt-5 grid gap-4 md:grid-cols-3">
      {[
        ['/hardware-prototype-assembled.jpg', 'The assembled prototype', 'A familiar large-button telephone provides the physical interface.'],
        ['/hardware-prototype-development.jpg', 'Built, tested and iterated', 'Internal hardware and software integration during development.'],
        ['/hardware-prototype-community.jpg', 'Taken into the community', 'The prototype presented as part of the wider Tellie experience.'],
